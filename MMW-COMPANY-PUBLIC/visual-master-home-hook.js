...
@media(prefers-reduced-motion:reduce){*,*:before,*:after{scroll-behavior:auto!important;transition:none!important}}
  ...
  out=out.replace('</style>',polish+'</style>');

  return out;
}

let html=null;
try{ html=completeVisualMaster(fs.readFileSync(HOME,'utf8')); }
catch(e){ console.error('[MMW-VISUAL-MASTER] homepage read failed:',e.message); }
