...
// Public runtime deliberately serves the project source pages without internal
// Factory/QA/duplicate financial overlays. Visual assets remain enabled.
...
function cleanText(html){return html
 ...
 .replace(/MMW PROJECT MASTER · V1/gi,'PROJECT DEVELOPMENT PACKAGE')
 .replace(/MMW-COMPANY · COMMERCIAL MASTER/gi,'MMW-COMPANY · COMMERCIAL SERVICES')
 .replace(/CONTROL ARCHITECTURE/gi,'PROJECT STANDARD')
 .replace(/READY-TO-SELL 100/gi,'PROJECT STANDARD')
